   ...
   MEMBER('ToDoWindow.clw')                                ! This is a MEMBER module
                     ...
                     MAP
                       INCLUDE('TODOWINDOW004.INC'),ONCE        !Local module procedure declarations
                     END
...
!!! </summary>
ReportStudentsBySTU:MajorKey PROCEDURE !Procedure not yet defined - added by GWBTODO
...
window               WINDOW,AT(,,241,144),FONT('Microsoft Sans Serif',8,,FONT:regular),CENTER,MDI
  ...
  CODE
  gwbProcedureName = 'ReportStudentsBySTU:MajorKey'
